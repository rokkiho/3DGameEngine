...
public class Transform
{
	...
	public Matrix4f getProjectedTransformation()
	{
		...
		Matrix4f cameraTranslation = new Matrix4f().initTranslation(-camera
				.getPos().getX(), -camera.getPos().getY(), -camera.getPos()
				.getZ());

		return projectionMatrix.multiply(cameraRotation.multiply(
				cameraTranslation).multiply(transformationMatrix));
	}
