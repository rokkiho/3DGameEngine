...
public class Mesh
{
	...
	public void draw()
	{
		...
		glVertexAttribPointer(1, 2, GL_FLOAT, false, Vertex.SIZE * 4, 4 * 3); // for
																				// textures
		glVertexAttribPointer(2, 3, GL_FLOAT, false, Vertex.SIZE * 4,
				4 * 3 + 4 * 2); // for normals
	...
	private Mesh loadMesh(String fileName)
	{
		...
		if (!ext.equals("obj"))
		{
			System.err.println("Error: File format not supported for mesh "
					+ ext);
